...
//             formData.append('id_motor', String(idMotor));
//             formData.append('data_entrada', new Date().toISOString());

//             // Andamento fixo em "9" (Aguardando Orçamento)
//             formData.append('id_andamento', '9');

//             // Observações de entrada (estado em que chegou)
//             if (observacoes) formData.append('observacoes_gerais', observacoes);

//             // Fotos da entrada do equipamento (opcional)
//             if (fotos) {
//                 Array.from(fotos).forEach(foto => {
//                     formData.append('fotos_queima', foto); // Mantive o nome do campo igual ao backend (multer)
//                 });
//             }
...
//             alert('Erro ao gravar a Ordem de Serviço.');
//         } finally {
