...
//     const subtotalServicos = osServicos.reduce((acc, item) => acc + Number(item.preco), 0) + osRebobinamentos.reduce((acc, item) => acc + Number(item.preco), 0);
//     const impostoServicos = subtotalServicos * 0.05;
//     const subtotalPecas = osPecas.reduce((acc, item) => acc + Number(item.preco), 0);
...
//                                             <td className="py-2" colSpan={2}>Nenhum serviço de rebobinamento lançado para esta O.S.</td>
//                                         </tr>
//                                     )}
//                                 </tbody>
//                             </table>
...
//                                     ) : (
//                                         <tr className="text-gray-400 italic">
//                                             <td className="py-2" colSpan={2}>Nenhum serviço geral/adicional lançado para esta O.S.</td>
//                                         </tr>
//                                     )}
//                                 </tbody>
//                             </table>
...
//                                     ) : (
//                                         <tr className="text-gray-400 italic">
//                                             <td className="py-2" colSpan={2}>Nenhuma peça ou material substituído para esta O.S.</td>
//                                         </tr>
//                                     )}
//                                 </tbody>
//                             </table>
